public class HelloWorld {
    ...
    public static void main(String [] args){
        ...
        //32 bits, ponto flutuante ou precisão simples
        float decimalSimples = 23;
        //64 bits, ponto flutuante ou precisão dupla
        double decimalPreciso = 34.2;
